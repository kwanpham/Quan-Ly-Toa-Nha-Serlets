...
INSERT INTO `user` (`id`, `username`, `password`, `fullName`, `roleId`, `createdDate`, `modifiedDate`, `createdBy`, `modifiedBy`, `status`) VALUES (NULL, 'user3', 'user3', 'Bui Phat', '2', '2019-03-06 00:00:00', NULL, 'Admin', NULL, '1');
INSERT INTO `user` (`id`, `username`, `password`, `fullName`, `roleId`, `createdDate`, `modifiedDate`, `createdBy`, `modifiedBy`, `status`) VALUES (NULL, 'user4', 'user4', 'Le Tuan Anh', '2', '2019-03-06 00:00:00', NULL, 'Admin', NULL, '1');
INSERT INTO `user` (`id`, `username`, `password`, `fullName`, `roleId`, `createdDate`, `modifiedDate`, `createdBy`, `modifiedBy`, `status`) VALUES (NULL, 'user5', 'user5', 'Chu Van Hoa', '2', '2019-03-06 00:00:00', NULL, 'Admin', NULL, '1');